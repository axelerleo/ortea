...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Форма Как выбрать стабилизатор';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U3630"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U3642"],ENT_COMPAT,'UTF-8') . '</td></tr>';
