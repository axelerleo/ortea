...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Форма Промышленные стабилизаторы';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U3214"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U3196"],ENT_COMPAT,'UTF-8') . '</td></tr>';
