...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Ваше имя*:</b></td><td>' . htmlentities($_REQUEST["custom_U312"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Ваш вопрос:</b></td><td>' . htmlentities($_REQUEST["custom_U302"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Сотовый телефон*:</b></td><td>' . htmlentities($_REQUEST["custom_U307"],ENT_COMPAT,'UTF-8') . '</td></tr>';
