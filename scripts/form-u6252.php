...
{
	$to = '';
	$subject = 'Отправка Форма how_it_works';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U6273"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U6262"],ENT_COMPAT,'UTF-8') . '</td></tr>';
