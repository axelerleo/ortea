...
function emailFormSubmission()
{
	...
	$subject = 'Отправка Форма Бытовые стабилизаторы';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Имя:</b></td><td>' . htmlentities($_REQUEST["custom_U2852"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Телефон:</b></td><td>' . htmlentities($_REQUEST["custom_U2860"],ENT_COMPAT,'UTF-8') . '</td></tr>';
